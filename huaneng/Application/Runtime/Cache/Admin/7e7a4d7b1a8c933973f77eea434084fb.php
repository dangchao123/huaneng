...
<div class="container clearfix">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/huaneng/index.php/Admin/Active/allActive">媒体活动管理</a><span class="crumb-step">&gt;</span><span>修改活动</span></div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form role="form" action="" method="post" enctype="multipart/form-data">
                <table class="insert-tab" width="100%"name="actives" id="actives">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($actives["title"]); ?>" type="text">
                        </td>
                    </tr>
                     <tr>
                            <th>描述：</th>
                            <td><textarea name="summary" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="3"><?php echo ($actives["summary"]); ?></textarea></td>
                        </tr>
                    <tr>
                        <th>时间：</th>
                        <td><input class="common-text required" id="title" name="time" size="50" value="<?php echo ($actives["time"]); ?>" type="date"></td>
                    </tr>
                     <tr>
                        <th>地点：</th>
                        <td><input class="common-text required" id="title" name="address" size="50" value="<?php echo ($actives["address"]); ?>" type="text"></td>
                    </tr>
                    <tr>
                        <th>上传：</th>
                        <td>
                            <img src="/huaneng/Public/<?php echo ($actives["img"]); ?>"  width="253px" height="165px" name="img"/>

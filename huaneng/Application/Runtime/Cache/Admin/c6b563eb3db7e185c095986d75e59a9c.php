...
<div class="container clearfix">
  ...
  <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/huaneng/index.php/Admin/Index/index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/huaneng/index.php/Admin/News/allCompanynews.html">新闻管理</a><span class="crumb-step">&gt;</span><span>修改新闻</span></div>
        </div>
                 ...
                 <form role="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                                <th>描述：</th>
                                <td><textarea name="summary" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="3"><?php echo ($news["summary"]); ?></textarea></td>
                            </tr>
                        <tr>
                            <th>内容：</th>
                        ...
                        <tr>
                            <th>上传：</th>
                            <td>
                                <img src="/huaneng/Public/<?php echo ($news["img"]); ?>"  width="253px" height="165px" name="img"/>

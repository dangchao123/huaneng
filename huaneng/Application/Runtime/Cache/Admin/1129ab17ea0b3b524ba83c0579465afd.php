...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="allNewses.html">管理员管理</a><span class="crumb-step">&gt;</span><span>编辑管理员</span></div>
        </div>
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <th>上传：</th>
                            <td>
                                <img src="/huaneng/Public/<?php echo ($administrators["img"]); ?>"  width="253px" height="165px" name="img"/>

...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            <h1 class="topbar-logo none"><a href="/huaneng/index.php/Admin/Index/indexindex.html" class="navbar-brand">后台管理</a></h1>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="allNewses.html">媒体活动管理</a><span class="crumb-step">&gt;</span><span>新增活动</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form role="form" action="/huaneng/index.php/Admin/Active/actadd" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th>描述：</th>
                            <td><textarea name="summary" class="common-textarea" id="summary" cols="30" style="width: 98%;" rows="3"></textarea></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>时间：</th>
                            <td>
                                <input class="common-text required" id="time" name="time" size="50" value="" type="date">
                            </td>
                        </tr>
                        <tr>

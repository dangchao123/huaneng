...
<div class="container clearfix">
   ...
   <div class="crumb-wrap">
            <div class="crumb-list">
                <i class="icon-font"></i>
                <a href="/huaneng/index.php/Admin/Index/index.html">首页</a>
                <span class="crumb-step">&gt;</span>
                <span class="crumb-name">所有新闻</span>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newse): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo (msubstr($newse["title"],0,10,'utf-8',true)); ?></td>
                            <td><?php echo (msubstr($newse["summary"],0,20,'utf-8',true)); ?></td>

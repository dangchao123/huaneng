...
<div class="container clearfix">
  ...
  <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/huaneng/index.php/Admin/Index/index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/huaneng/index.php/Admin/Project/allProjects.html">方案管理</a><span class="crumb-step">&gt;</span><span>新增方案</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form role="form" action="/huaneng/index.php/Admin/Project/projectadd" method="post" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th width="120"><i class="require-red">*</i>方案种类：</th>
                                    ...
                                    <td>
                                    <input class="common-text required" id="title" name="category" size="50" value="" type="text">
                            ...
                            <tr>
                                <th>方案图片：</th>
                                <td>
                                    <input class="common-text required" id="title" name="img" size="50" value="" type="file">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>方案介绍（应用场景）：</th>
                            ...
                            <tr>
                                ...
                                <td><textarea name="feature" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>系统结构图：</th>
                                <td>
                                    <input class="common-text required" id="title" name="img1" size="50" value="" type="file">
                                </td>
                            </tr>
                            <tr>
                                <th>备注：</th>

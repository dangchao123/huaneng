...
<div class="container clearfix">
   ...
   <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/huaneng/index.php/Admin/Index/index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/huaneng/index.php/Admin/Administrator/allAdministrator.html">管理员管理</a><span class="crumb-step">&gt;</span><span>编辑管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="name" size="50" value="<?php echo ($administrator["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" id="title" name="password" size="50" value="<?php echo ($administrator["password"]); ?>" type="password">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>邮箱：</th>
                                <td>
                                    <input class="common-text required" id="title" name="email" size="50" value="<?php echo ($administrator["email"]); ?>" type="email">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>电话：</th>
                                <td>
                                    <input class="common-text required" id="title" name="phone" size="50" value="<?php echo ($administrator["phone"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                            <th>上传：</th>
                            <td>
                                <img src="/huaneng/Public/<?php echo ($administrator["img"]); ?>"  width="253px" height="165px" name="img"/>

                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="date"value="<?php echo ($actives["time"]); ?>" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>地点：</th>
                            <td>
                                <input class="common-text required" id="title" name="address"value="<?php echo ($actives["address"]); ?>"  size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>上传：</th>

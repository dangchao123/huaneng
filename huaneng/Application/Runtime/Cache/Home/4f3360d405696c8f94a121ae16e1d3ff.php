		...
		<div class="container">
			<div class="breadcrumb1">				
				<ol class="breadcrumb">
					...
					<li class="active">媒体新闻</li>
				</ol>
			</div>
			<div class="nav2">
	            <ul>
                    <li><a href="/huaneng/index.php/Home/News/companynews.html">公司新闻</a></li>
	                <li><a  class="active" href="/huaneng/index.php/Home/News/mediannews.html">媒体新闻</a></li>
       ...
       <div class="container">
        <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="overview-grids">
                 <div class="col-md-4 list-grid2"style="margin-top:2em;">
                    <div class="list-img">
                        <a href="/huaneng/index.php/Home/News/content1/id/<?php echo ($vo["id"]); ?>">   <img src="/huaneng/Public/<?php echo ($vo["img"]); ?>" class="img-responsive" alt=" "style="width:350px;height:200px;"></a>
                        <div class="textbox"></div>
                    </div>
                    <h4 style="font-size:20px;font-weight: 300;"> <a href="/huaneng/index.php/Home/News/content1/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h4>

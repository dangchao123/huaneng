...
<!-- header -->
	...
	<div class="agile-prod">
		<div class="container">
			...
			<div class="nav2">
	            <ul>
	                <li><a href="媒体新闻.html">媒体新闻</a></li>
	                
	                <li><a class="active"href="公司新闻.html">公司新闻</a></li>
	            </ul>
			</div>
		</div>
    </div>
    ...
    <div class="overview w3-2">
	   <div class="container">
		   ...
		   <div class="overview-grids">
                 <div class="col-md-3 list-grid2">
                    <div class="list-img">
                        <a href="新闻内容.html">   <img src="/huaneng/Public/before/images/g4.jpg" class="img-responsive" alt=" "></a>
                        <div class="textbox"></div>
                    </div>
                      <h4> <a href="新闻内容.html">华能电源入选..</a></h4>
                    <p>为加快推进新能源微电网示范工程建设，探索适应新能源发展的微电网技术及运营管理体制，日前，国家发改委、国家能源局下发通 </p>
                 </div>
                 <div class="col-md-3 list-grid2">
                    <div class="list-img">
                        <img src="/huaneng/Public/before/images/g7.jpg" class="img-responsive" alt=" ">
                        <div class="textbox"></div>
                    </div>
                      <h4><a href="新闻内容.html">臻于至善 领跑未..</a></h4>
                    <p> 为加快推进新能源微电网示范工程建设，探索适应新能源发展的微电网技术及运营管理体制，日前，国家发改委、国家能源局下发通</p>
                 </div>
                 <div class="col-md-3 list-grid2">
                    <div class="list-img">
                        <img src="/huaneng/Public/before/images/g9.jpg" class="img-responsive" alt=" ">
                        <div class="textbox"></div>
                    </div>

                    <h4><a href="新闻内容.html">光伏电站“水上漂”，华能电..</a></h4>
                      <p> 为加快推进新能源微电网示范工程建设，探索适应新能源发展的微电网技术及运营管理体制，日前，国家发改委、国家能源局下发通</p>
                 </div>
                 <div class="col-md-3 list-grid2">
                    <div class="list-img">
                        <img src="/huaneng/Public/before/images/g4.jpg" class="img-responsive" alt=" ">
                        <div class="textbox"></div>
                    </div>
                      <h4><a href="新闻内容.html">华能电源入选..</a></h4>
                    <p>为加快推进新能源微电网示范工程建设，探索适应新能源发展的微电网技术及运营管理体制，日前，国家发改委、国家能源局下发通 </p>
    ...
    <div class="container">
        <div>
            <h4 class="w3ls_head">往期<span>新闻</span></h4>
        </div>
        <div class="services-grids">
            ...
            <div class="col-md-4 services-grid">
                ...
                <div class="services-right">
                    <h4><a href="新闻内容.html">精益协同 共赢未来</a></h4>
                    <p>我们可以一起思考，大胆变革，协同创新，贴近客户。...</p>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-4 services-grid">
